...
Mock was contributed to the HashiCorp community by [hasheddan](https://github.com/hasheddan/vault-plugin-accounts-covert). In doing so, the original license has been removed.
